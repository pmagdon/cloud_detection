...
files = os.listdir("C:/Users/anpla/data/500m/field")
...
for file in files:
    ...
    # Output: list updated
    first_import("C:/Users/anpla/data/500m/field/" + file, image_set)
...
import_cloudfree_reference("C:/Users/anpla/data/500m/field/2015-03-19.tif", dictionary_masked)
...
for date in list(dictionary_blue_red["blue"].keys())[1:]:
    cloud_mask(date, 3, 10, 5, 0.70, dictionary_blue_red, dictionary_masked, 1, dictionary_masked_test)
...
for mask in dictionary_masked_test:
    array2raster_3b("C:/Users/anpla/data/500m/field/"+mask+".tif", "3_10_5_70_3b"+mask+".tiff",
