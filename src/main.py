...
import_cloudfree_reference("C:/Users/anpla/data/500m/forest1/2015-03-19.tif", dictionary_masked)
...
for date in list(dictionary_blue_red["blue"].keys())[1:]:
    cloud_mask(date, 3, 15, 11, 0.99, dictionary_blue_red, dictionary_masked, 1, dictionary_masked_test)

for mask in dictionary_masked:
    array2raster("C:/Users/anpla/data/500m/forest1/"+mask+".tif",
                 "3_15_11_99_"+mask+".tiff", 5, 5, dictionary_masked, mask)

for mask in dictionary_masked_test:
    array2raster_3b("C:/Users/anpla/data/500m/forest1/"+mask+".tif", "3_15_11_99_3b"+mask+".tiff",
