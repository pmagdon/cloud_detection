...
def cloud_mask(date, window_size, dic_values, dic_mask):
    """
    ...
    :param int window_size: the size of the window for the part 3 of the multi temporal cloud detection test
    ...
    cloud_mask_list = [mtcd(date, r, c, window_size, dic_values, dic_mask)
